# Optimal planning: from feature request to implementation plan

**Note:** A separate `PLANNING-STRATEGY.md` file is **not** included in this bundle—use this document as a standalone overview, or pair it with `plan-feature.md` in this folder.

**Related files in this folder:**

- `plan-feature.md` — executable slash-command body  
- This file — explanation and usage notes  
...
1. **Read this overview (`optimal_planning.md`)**
   - Understand the 6-phase process
   - Learn why each phase matters
   - See the anti-patterns to avoid

2. **Have your `plan-feature` command available** (e.g. `commands/plan-feature.md` or your tool’s equivalent path)
...
1. **Read**: this file (`optimal_planning.md`) — understand the philosophy
