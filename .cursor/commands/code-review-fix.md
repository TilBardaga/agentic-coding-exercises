...
When done, follow **[`.cursor/skills/check-project-health/SKILL.md`](../skills/check-project-health/SKILL.md)** in **Implementation mode** (simple fixes + re-run until checks pass), or follow root **`README.md`** / **`AGENTS.md`** if the skill does not apply, then summarize results.
